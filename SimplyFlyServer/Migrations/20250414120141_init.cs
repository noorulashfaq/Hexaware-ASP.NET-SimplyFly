    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightRoute", x => x.RouteId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaggageInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "AirlineId");
                    table.ForeignKey(
                        name: "FK_Flights_FlightRoute_RouteId",
                        column: x => x.RouteId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PriceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlightId = table.Column<int>(type: "int", nullable: false),
                    PremiumClass = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    EconomicClass = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BusinessClass = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cancellations", x => x.CancelId);
                    table.ForeignKey(
